...
#define I2C2     							((I2C_t *)(I2C2_BASE_ADDRESS))
...
#define I2C1_CLK_EN()						SET_BIT(RCC->APB1ENR, 21)
#define I2C1_CLK_DIS()						CLEAR_BIT(RCC->APB1ENR, 21)
#define I2C1_CLK_RST()						SET_BIT(RCC->APB1RSTR, 21)

#define I2C2_CLK_EN()						SET_BIT(RCC->APB1ENR, 22)
#define I2C2_CLK_DIS()						CLEAR_BIT(RCC->APB1ENR, 22)
#define I2C2_CLK_RST()						SET_BIT(RCC->APB1RSTR, 22)
...
// I2C IRQ Numbers
#define I2C1_EVENT_IRQ                       31
#define I2C1_ERROR_IRQ                       32
#define I2C2_EVENT_IRQ                       33
#define I2C2_ERROR_IRQ                       34
